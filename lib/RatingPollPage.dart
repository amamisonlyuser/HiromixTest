...
class RatingPollPage extends StatefulWidget {

  final String phone_number;
  final String institution_short_name;

  const RatingPollPage({
    super.key,
  ...
  @override
  _RatingPollPage createState() => _RatingPollPage();
}

class _RatingPollPage extends State<RatingPollPage> {
